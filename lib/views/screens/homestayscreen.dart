...
class _HomestayScreenState extends State<HomestayScreen> {
                                ...
                                child: SizedBox(
                                    child: Row(
                                        ...
                                        children: [
                                            ...
                                            // for google map, require sdkversion update
                                            // IconButton(
                                            //     iconSize: 32,
                                            //     onPressed: isDisable
                                            //         ? null
    ...
    Future<void> _onRoute() async {
        ...
        //         "," +
        //         widget.homestay.homestayLon.toString() +
        //         "20z");
        // await launchUrl(launchUri);
    }
    ...
    void _onShowMap() {
        ...
        double lon = double.parse(widget.homestay.homestayLon.toString());
        ...
        // Completer<GoogleMapController> ncontroller = Completer<GoogleMapController>();
